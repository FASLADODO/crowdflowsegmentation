...
%img1 = imread('C:\Users\srish\Downloads\Flow\Flow\car0.png');
%img2 = imread('C:\Users\srish\Downloads\Flow\Flow\car1.png');
[ht, wt, dt] = size( img1 ) ;

num_levels = 4; % for face; Number of pyramid levels. Can also be calculated automatically
